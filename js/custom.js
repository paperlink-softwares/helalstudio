...
jQuery(document).ready(function($) {
        ...
        $(document).bind('ready scroll', function() {
            ...
            if ($('#header').length && docScroll >= headerH) {
                if (!$('#header').hasClass('header-animate') && !$('#header').hasClass('nav-is-visible')) {
                    $('#header').addClass('header-animate').css({
                        top: '-155px'
                    }).stop().animate({
                        top: 0
                    }, 500);
    ...
    $('.loadmore').on("click", function(e) {
        ...
        if (j == 3) {
            $('.loadmore').html('<i class="fa fa-exclamation-triangle"></i> <span> Thats All!! </span>').css({
                "cursor": "default"
            });
            ...
            $.ajax({
                ...
                complete: function() {
                    if (j == 2) {
                        ...
                        $('.loadmore').html('<i class="fa fa-paint-brush"></i> <span> More Art </span>').css({
                            "cursor": "pointer"
                        });
